defmodule Launchkit.Campaigns do
  @moduledoc """
  ...
  Returns `nil` if the Website does not exist.

  ## Examples

      iex> get_website_by_url("https://example.com")
      %Website{}

      iex> get_website_by_url("https://nonexistent.com")
      nil

  """
  def get_website_by_url(url) when is_binary(url) do
